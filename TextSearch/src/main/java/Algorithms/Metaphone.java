...
public class Metaphone {
	...
	// Genera magicamente la codificacion mediante reglas complicadas y despues
	// para calcular la similaridad entre los strings los compara char a char.
	// La similaridad se calcula haciendo la cantidad de chars iguales dividido el
	// total de chars en el string mas largo.
